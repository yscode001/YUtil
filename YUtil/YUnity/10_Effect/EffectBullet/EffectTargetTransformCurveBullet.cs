...
namespace YUnity
{
    ...
    public partial class EffectTargetTransformCurveBullet
    {
        ...
        public void Play(bool isUseCurveDir, Vector3 curveDir, int curveRandomSeed, Transform targetTransform, float moveSpeed, float limitReachDis, Action targetDestroyWhenFlying, Action reachedTargetComplete)
        {
            Clear();
