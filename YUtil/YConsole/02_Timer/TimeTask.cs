...
namespace YConsole
{
    ...
    public partial class TimeTask
    {
        ...
        public TimeTask(Action<string> taskLog, uint repeatTimeInterval)
        {
    ...
    public partial class TimeTask
    {
         ...
         */
        private Action<Action<uint>, uint> taskHandleThread;
        public void SetTaskHandleThread(Action<Action<uint>, uint> taskHandleThread)
        {
                ...
                else // 时间已到，执行
                {
                    ...
                    if (cb != null)
                    {
                        try
                        {
                            ...
                            {
                                taskHandleThread(cb, task.taskID);
                            }
                            else
                            {
